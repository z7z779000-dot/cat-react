      ...
      <div className="container">
        <div className="row">
          <div className="col-md-4 mb-4">
            <h5 className="text-warning fw-bold mb-3">Literary World</h5>
            <p className="text-muted small">Your ultimate destination for classic and contemporary literature.</p>
          </div>
        ...
        <p className="text-center text-muted small">© 2026 Literary World. All rights reserved.</p>
      </div>
    </footer>
  );
}
